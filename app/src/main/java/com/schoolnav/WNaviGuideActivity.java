    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNaviHelper.setWalkNaviStatusListener(new IWNaviStatusListener() {
            ...
            public void onNaviExit() {
                ...
                Toast toast = Toast.makeText(WNaviGuideActivity.this, "正在进入实景导航", Toast.LENGTH_LONG);
                toast.show();
                Intent intent = new Intent();
                intent.setClass(WNaviGuideActivity.this, ArActivity.class);
...
//                Log.d(TAG, "导航结束");
//                Intent intent = new Intent();
//                intent.setClass(WNaviGuideActivity.this, TestActivity.class);
//                startActivity(intent);
            }
